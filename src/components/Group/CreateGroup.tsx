  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: BLACK }}>
      ...
      <View style={{ paddingHorizontal: 20 }}>
        ...
        <FlatList
          data={data}
          style={{ borderWidth: 1, borderColor: WHITE, borderRadius: 8, maxHeight: 200, marginBottom: 20, marginTop: 15 }}
          renderItem={({ item }: any) => {
            const { rep_pic, nickname } = item;
            return (
              <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: WHITE, padding: 10 }}>
                ...
                <TouchableOpacity
                  onPress={() => {
                    ...
                    :
                    setGroup({...group, members: [...group.members, nickname]})
                  }}
                  style={{
                    width: 80,
                    height: 25,
                    backgroundColor: group.members.includes(nickname) ? LIGHTBLACK : MINT,
                    justifyContent: 'center',
                    alignItems: 'center',
                    borderRadius: 12,
                  }}>
                  <B12 style={{color: group.members.includes(nickname) ? WHITE : BLACK}}>
