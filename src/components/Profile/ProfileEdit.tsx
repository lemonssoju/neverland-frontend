...
import { SafeAreaView, Image, TouchableOpacity, Modal, View, Pressable } from 'react-native';
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{alignItems: 'center', marginVertical: 20}}>
        <Image source={{uri: profile.rep_pic}} style={{width: 85, height: 85, borderRadius: 180}} />
      ...
      <View style={{flex: 1, marginTop: 20}}>
        <Input
          ...
          onChangeText={(nickname) => setProfile({...profile, nickname: nickname})}
        />
        ...
        <Input
          ...
          onChangeText={(introduction) => setProfile({...profile, introduction: introduction})}
        ...
        />
        <TouchableOpacity style={{position: 'absolute', right: 20, top: 175}} onPress={() => setMusicVisible(true)}>
          <LinkIcon />
        </TouchableOpacity>
      </View>
      <BottomButton label='수정 완료' onPress={() => navigation.navigate('ProfileHome')} />
      <Modal visible={musicVisible} transparent>
        ...
        <View style={{backgroundColor: LIGHTBLACK, position: 'absolute', width: '80%', height: 150, top: 340, alignSelf: 'center', borderRadius: 24, paddingVertical: 15}}>
          <Input
            ...
            onChangeText={(musicUrl) => {setProfile({ ...profile, musicUrl: musicUrl})}}
          ...
          <View style={{flexDirection: 'row', paddingHorizontal: 20, justifyContent: 'space-between'}}>
            <TouchableOpacity 
              ...
              onPress={() => {
                setProfile({ ...profile, musicUrl: ''}); setMusicVisible(false)
              }}
            >
